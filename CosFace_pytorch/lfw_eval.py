...
def eval(model, model_path=None, is_gray=False):
    ...
    model.eval()
    root = '/media/Data/yangty/arcface/arcface-pytorch/data/Datasets/lfw/lfw-align-128/'
    with open('/media/Data/yangty/arcface/arcface-pytorch/data/Datasets/lfw/lfw_test_pair.txt') as f:
...
def test_oneimg():
    ...
    with torch.no_grad():
        with open('test.jpg', 'rb') as f:
            ...
            img2=img.resize((96,112))
            f = extractDeepFeature(img2, model, False)
            print(f.shape)
'''
if __name__ == '__main__':
    _, result = eval(net.LResNet50E_IR(), model_path='ACC99.28.pth')
